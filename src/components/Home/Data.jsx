...
const Data = () => {
  return (
    <div className="home__data">
      ...
      <p className="home__description">I'm an aspiring Full-stack developer specializing in the MERN stack, passionate about building impactful web applications. As a final-year B.Tech student, I love transforming ideas into practical solutions that solve real problems and offer a great user experience. My focus is on learning, growing, and creating meaningful technology that makes a difference. Welcome to my portfolio—where I share my journey, skills, and the projects that inspire me..</p>
