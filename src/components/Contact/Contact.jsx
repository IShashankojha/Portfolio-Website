            ...
            <div className="contact__info">
                ...
                <i className="bx bxl-whatsapp contact__card-icon"></i>
                    ...
                    <h3 className="contact__card-title">Whatsapp</h3>
                        ...
                        <a href="https://api.whatsapp.com/send? phone=62214408789&text=Hello, more information!" className="contact__button">Connect{" "}
                            <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                  </div>
                ...
                <i className="bx bxl-messenger contact__card-icon"></i>
                    ...
                    <h3 className="contact__card-title">Facebook</h3>
                        <span className="contact__card-data">Shashankojha</span>

                        <a href="https://www.facebook.com/IShashankojha?mibextid=ZbWKwL" className="contact__button">Connect{" "}
                            <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                 </div> 
            </div>
            </div>
                  ...
                  <form ref={form} onSubmit={sendEmail} className="contact__form">
                    ...
                    <div className="contact__form-div contact__form-area">
                        <label className="contact__form-tag">Message</label>
                            ...
                            className="contact__form-input" placeholder="Enter your text"></textarea>
                    </div>
